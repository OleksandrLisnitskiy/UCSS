...
const translationsUk = {
    ...
    'Learn more about us': 'Дізнайтеся більше про нас',
    ...
    'These links connect community members to housing, employment, education, health, immigration, seniors, family, and community resources': 'Ці посилання допомагають членам громади знаходити ресурси у сферах житла, працевлаштування, освіти, охорони здоров’я, імміграції, підтримки людей старшого віку, сімейних послуг та програм для громади',
