...
const translationsUk = {
    ...
    'History, Board of Directors, Membership & Volunteering, and Equity Statement information for Ukrainian Canadian Social Services - Edmonton.': 'Інформація про історію, Управу, членство, волонтерство та заяву про рівність UCSS Edmonton.',
    'History': 'Історія',
    ...
    'UCSS - Edmonton Board of Directors 2026-2027': 'Управа ССУК-Едмонтон 2026-2027',
    ...
    "UCSS Edmonton's Equity Statement is available from the original website in English and Ukrainian.": 'Заява UCSS Edmonton про рівність доступна з оригінального сайту англійською та українською мовами.',
